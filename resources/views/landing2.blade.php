    ...
    <div class="container-fluid" data-aos="zoom-out" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-10">
          <div class="row">
            <div class="col-xl-5">
              <h1>Selamat Datang di Smart Maharani</h1>
              <h2>Website Resmi Kelurahan Maharani Kota Pekanbaru</h2>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="{{asset('image/8.jpeg')}}" class="img-fluid" alt="">
    ...
    <section id="faq" class="faq">
      <div class="container" data-aos="fade-up">
        ...
        <ul class="faq-list" data-aos="fade-up">
          ...
          <li>
            <a data-toggle="collapse" class="collapsed" href="#faq1">Jam buka<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-x icon-close"></i></a>
        ...
        <div class="row" style="align-items: center;justify-content:center">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="{{ asset('image/camat.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                <h4>Jasrul Hanip, S.Pd. MM</h4>
                <span>Camat Rumbai Barat</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="{{ asset('image/lurah.jpg') }}" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                <h4>Zulkifli, S.Sos</h4>
                <span>Lurah Maharani</span>
              </div>
            </div>
          </div>
