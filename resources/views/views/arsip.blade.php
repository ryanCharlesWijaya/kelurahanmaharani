...
@section('container')
<h1 style="padding-top:3%;">Arsip</h1>
...
<table class="table table-bordered " id="arsip-table" style="text-align:center">
    <thead class="table-warning">
        ...
        <th scope="col">Terakhir Diedit</th>
    ...
    <tbody class="text-dark" style="text-align:center">
        <tr>
            <td>1</td>
            <td>123321</td>
            <td>1471071234560001</td>
            <td>Giorno Giovanna</td>
            <td>25/8/2021</td>
            <td>25/8/2021</td>
            <td>
                <a class="btn m-0 p-0" target="_blank" href="/file/OrderPS268239.pdf">
            ...
            <td>
                <a title="update" href="edit" class="btn m-0 p-0">
            ...
            <td>
                <a title="delete" class="btn m-0 p-0">
