    ...
    <head>
        ...
        <style>
            ...
            tbody tr:nth-child(odd){
                background-color: rgba(203,254,206, 0.5);
            }
            tbody tr:nth-child(even){
                background-color: rgba(212,255,206, 0.2);
            }
        ...
        <div class="d-flex" id="wrapper" >
            ...
            <div style="position:sticky;top:0rem;">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light h5 p-3 m-0" href="Login">
                        <span>
            ...
            <nav class="navbar-mobile">
                <button class="navbar-mobile-button" onclick="showNav()">
                    ...
                    <a class="navbar-mobile-item" href="Login">
                        <span>
                    <svg class="svg" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 512.005 512.005" style="enable-background:new 0 0 512.005 512.005;" xml:space="preserve">
                    <g>
