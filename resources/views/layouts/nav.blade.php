        ...
        <nav class="nav">
            <div> 
                <div class="nav_list"> 
                    ...
                    <a href="{{ route('question.index') }}" class="nav_link"> 
                        <svg class="nav_icon svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 973.1 973.1" style="enable-background:new 0 0 973.1 973.1;" xml:space="preserve">
<g>
